function Experience() {
     return (
          <section
               ...
               id="#experiencia"
               className="grid-cols-custom-layout mt-64 relative mb-40 "
          >
               <h2 className="text-9xl font-semibold text-gray-300 mb-56 max-sm:text-7xl max-smallscreen:text-5xl">
                    Experiência
               </h2>
               ...
               <div className="bg-slate-100 grid grid-cols-2 p-6 shadow-lg max-lg:w-full mr-1 absolute max-md:w-full pl-10 max-smartphone:grid-cols-1 max-md:gap-4 ">
                    ...
                    <ul id="thumb-grid" className="grid grid-cols-3 justify-items-center gap-2 shadow-md  text-sm text-gray-900 bg-slate-200/40 max-smartphone:shadow-none max-smartphone:bg-transparent p-3 rounded  ">
