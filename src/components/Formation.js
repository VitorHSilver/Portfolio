...
function Formation() {
     return (
          ...
          >
               <div className="p-8">
                    <h2 className="font-bold text-9xl mb-12 max-md:text-6xl max-sm:text-5xl max-sm:mt-24 max-smartphone:text-6xl max-smallscreen:mb-[4rem] max-smallscreen:text-6xl">
                         Formação
                    </h2>
