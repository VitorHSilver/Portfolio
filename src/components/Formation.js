...
function Formation() {
     return (
          <section id="formacao" className="bg-black w-full mt-80 py-14 text-gray-100/25 max-sm:mt-[40rem] max-sm:py-0">
               <div className="p-8">
                    ...
                    <div className="flex justify-end mt-4">
                         <p className="text-gray-100/75 tracking-wider subpixel-antialiased pr-2 leading-normal mt-12  max-sm:mt-4">
                    ...
                    <div className="flex justify-around mt-24 max-lg:gap-1 max-sm:gap-2  max-smartphone:gap-1 max-smartphone:grid">
                         <div className="grid gap-y-4 bg-bgBlack rounded-lg p-3 text-center max-sm:border border-gray-50 max-md:border max-sm:shadow-none    shadow-sm shadow-slate-50/50  hover:shadow-emerald-300  transition duration-1000 ease-in">
                         ...
                         <div className="grid gap-y-4 bg-bgBlack rounded-lg p-3 text-center max-sm:border border-gray-50 max-md:border max-sm:shadow-none  max-smartphone:mt-4 shadow-sm shadow-slate-50/50  hover:shadow-emerald-300  transition duration-1000 ease-in">
                    ...
                    <div className="mt-24">
                         <h3 className="text-gray-100/50 text-5xl font-semibold text-center max-sm:mb-10 max-smallscreen:text-4xl">
                              Cursos
                         </h3>
